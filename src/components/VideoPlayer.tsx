    ...
    const handleSaveProgress = async (isCompOverride?: boolean) => {
      if (playerInstanceRef.current && playerInstanceRef.current.getCurrentTime) {
        ...
        await upsertWatchHistory({
          ...
          data: {
            movie_id: episodeIdRef.current ? null : (movieIdRef.current || null),
    ...
    return (
      <div className="relative w-full h-full bg-black">
        ...
        {/* <div className="absolute bottom-20 left-6 right-6 h-1.5 bg-white/10 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-blue-600 to-indigo-500 transition-all duration-300 shadow-[0_0_12px_rgba(37,99,235,0.4)]"
