      ...
      <nav className="fixed top-6 left-0 right-0 z-50 flex items-center h-14 transition-all duration-500">
        <div className="max-w-full px-6 w-full flex items-center justify-between h-14 relative">
          ...
          <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className="flex items-center bg-black/20 backdrop-blur-md rounded-full px-2 py-1 border border-white/10">
              ...
              <Link
                  to="/"
                  className="text-white hover:bg-purple-600 hover:text-white transition-colors px-4 py-2 rounded-full text-sm font-medium"
        ...
        {isMenuOpen && (
            <div className="md:hidden py-4 space-y-2 border-t border-gray-800 bg-black/20 backdrop-blur-md">
              <Link to="/" className="block text-white hover:text-gray-300 transition-colors py-2 px-6" onClick={e => handleNavClick(e, "/")}>Home</Link>
              <Link to="/movies" className="block text-white hover:text-gray-300 transition-colors py-2 px-6" onClick={e => handleNavClick(e, "/movies")}>Movies</Link>
              <Link to="/series" className="block text-white hover:text-gray-300 transition-colors py-2 px-6" onClick={e => handleNavClick(e, "/series")}>TV Shows</Link>
              <Link to="/my-list" className="block text-white hover:text-gray-300 transition-colors py-2 px-6" onClick={e => handleNavClick(e, "/my-list")}>Favorites</Link>
            </div>
        )}
      </nav>
  );
