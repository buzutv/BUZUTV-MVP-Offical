                        ...
                        >
                          <div className="space-y-1">
                            {season.episodes.map((episode) => (
                              <div
                                key={episode.id}
                                className="border border-brand-500/20 flex items-center space-x-3 bg-black  rounded-lg p-3 hover:border-white hover:shadow-[0_0_8px_rgba(255,255,255,0.6)] transition-all duration-300 group h-12"
                              >
                                <div
